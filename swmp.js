...
// @icon  data:image/png;base64,
    ...
    this.fullscreen = (element) => {
      ...
      if (fullscreenElement) {
        ...
        if (element.requestFullscreen) {
          ...
          // If no fullscreen on div is supported:
          this.toggleMaximize();
          return;
        }
        this.container.classList.add('swmp-fullscreen');
